...
export default function RecipeCard({recipe}) {
   ...
   return (
      <Link to={recipe.url} className="w-full">
         ...
         <GatsbyImage image={image} style={{position: 'absolute'}} className="absolute inset-0 w-full h-full rounded-xl overflow-hidden" imgClassName="rounded-xl" alt={recipe.data.preview.alt}/>
         </figure>
         <div className="mt-3">
