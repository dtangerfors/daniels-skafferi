   ...
   return (
      <Link to={category.url} className="group relative rounded-2xl pt-full w-full overflow-hidden">
         <figure className="absolute inset-0 w-full h-full z-1 rounded-2xl overflow-hidden">
            <img className="object-cover w-full h-full -z-1 transform-none group-hover:transform group-hover:scale-105 transition-all duration-5000" src={category.data.preview.url}  alt={category.data.preview.alt}/>
